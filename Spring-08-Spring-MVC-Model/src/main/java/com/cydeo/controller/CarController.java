...
public class CarController {
    @RequestMapping("/info") //localhost:8080/car/info?make=subaru
    ...
    @RequestMapping("/info2") //localhost:8080/car/info?make=subaru
    public String carInfo2(@RequestParam (value="make",required = false,defaultValue = "Tesla")String make,Model model){
        model.addAttribute("make",make);
        return "/car/car-info";
    }

    @RequestMapping("/info/{make}/{year}") //localhost:8080/car/info/subaru/2021
